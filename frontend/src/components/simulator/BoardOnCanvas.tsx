...
import { getBoardProfile } from '../../boards/BoardRegistry';
import { getBoardRenderer } from '../../boards/renderers';
...
export const BoardOnCanvas = ({
  ...
  const boardEl = (() => {
    ...
    return getBoardRenderer(profile?.rendererId)?.({ id, x, y, running: !!board.running, led13, boardKind }) ?? null;
  })();
